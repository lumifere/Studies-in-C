/*
Programa: lista4a_exerc7b.c
Autor: Pedro Mateus Melo Ormesino Lins
Data: 07/01/2022
Descrição: Gera 9.999.999 pontos cujas coordenadas estão dentro do círculo (0 <= x,y <= 1.0), calculando o Pi posteriormente.
*/
...
int main (void) {
    ...
    int dentro = 0;
    double x = 0, y = 0, sorteio = 9999999;
